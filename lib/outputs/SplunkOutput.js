 ...
 * @param {String} [options.GUID] GUID channel identifier for HEC raw endpoint submission
 * @param {String} [options.indexField] The Splunk index to submit data to
 ...
 * @param {Number} [options.port=8088] Network port to send requests to
...
let SplunkOutput = function (options) {
    ...
    self.indexField = useOptions.indexField
