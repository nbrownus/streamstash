 ...
 * @constructor
 */
var StdOutOutput = function (options) {
    StdOutOutput.super_.call(this)
...
StdOutOutput.NAME = "StdOut"
StdOutOutput.DESCRIPTION = "Outputs events to stdout"

util.inherits(StdOutOutput, EventEmitter)
