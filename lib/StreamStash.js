 ...
 *
 * @param {EventContainer|EventContainer[]} eventContainer An event or array of events that have finished processing
...
StreamStash.prototype._handleProcessingComplete = function (eventContainers, canceled) {
    ...
    this.stats.events.processing -= events.length
