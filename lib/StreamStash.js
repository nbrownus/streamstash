...
//TODO: high processing watermark?
//TODO: record event telemetry per input/output
//TODO: expose Telemetry to inputs/outputs so they can record their own stats
...
var StreamStash = function (options) {
    ...
    self.highWatermark = 200000
    self.lowWatermark = 50000
...
StreamStash.prototype._handleInputEvent = function (plugin, eventContainer) {
    ...
    if (this.stats.events.processing > this.highWaterMark) {
        this.pausedInputs = true
        //TODO: need kill timer
        this.emit('stopInput')
